function vmod = ontario_odes_inf1_2beta(t, x, N, a)	%feb26 to mar21 parameters, t = time, x = state var, N = pop, a = multiplier for loop

c = 11.5539;	%contact rate
beta = a*0.1450;	%prob of transmission
