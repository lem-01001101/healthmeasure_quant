function vmod = ontario_odes_inf1_2q0(t, x, N, a)	%feb26 to mar21 parameters, t = time, x = state var, N = pop, a = multiplier for loop

c = 11.5539;	%contact rate
beta = 0.1450;	%prob of transmission
q = a*0.1479; 	%quanratine rate of exposed indiv
