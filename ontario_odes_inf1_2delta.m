function vmod = ontario_odes_inf1_2delta(t, x, N, a)	%feb26 to mar21 parameters, t = time, x = state var, N = pop, a = multiplier for loop

c = 11.5539;	%contact rate
beta = 0.1450;	%prob of transmission
q = 0.1479; 	%quanratine rate of exposed indiv
...
deltaI = a*0.1;	%transition rate of symptomatic infected indiv to quarantined infected
%delta1delta10 = ;
%r2 = ;
%delta_if = ;
...
theta = 0.0465;	%modification factor of symptomatic infectiousness
